...
func ImportDefaultScenarios(scenarios map[string]models.Scenario) {
	savedScenarios := map[string][]byte{
		...
		"Сценарий 5м": {
			0x7e, 0x00, 0x01, 0x0d, 0xd1, 0xf6, 0xe5, 0xed, 0xe0, 0xf0, 0xe8, 0xe9, 0x20, 0x35, 0xec, 0x00,
			0xfd, 0xfd, 0xfd, 0xfd, 0xf2, 0x47, 0xb4, 0x00, 0x00, 0x00, 0x01, 0x13, 0xf4, 0x01, 0x15, 0x32,
			0x00, 0x14, 0x2c, 0x01, 0x11, 0x02, 0x03, 0x2f,
		},
	}
